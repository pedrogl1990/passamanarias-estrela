      ...
      <article className="article-history-1">
        <div>
          ...
          <p>
            ...
            da matéria-prima e excelência nos detalhes. É esse legado que
            procuramos manter sempre vivo por várias gerações.
          </p>
        </div>
        <div>
          <img
      ...
      <article className="article-history-2">
        <div>
          ...
          <p>
            ...
            instalações onde se iniciou este projecto há mais de 50 anos atrás.
          </p>
          <p>
            As raízes que nos prendem a este chão são as mesmas que nos
            continuam a inspirar nos dias que correm e é por isso que as
            mantemos, porque uma empresa com raízes sólidas saber sempre de onde
